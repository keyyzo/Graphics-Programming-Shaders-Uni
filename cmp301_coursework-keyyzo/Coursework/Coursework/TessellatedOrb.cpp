...
TessellatedOrb::TessellatedOrb(ID3D11Device* device, ID3D11DeviceContext* deviceContext, int lresolution)
{
...
void TessellatedOrb::initBuffers(ID3D11Device* device)
{
	VertexType* vertices;
...
void TessellatedOrb::sendData(ID3D11DeviceContext* deviceContext, D3D_PRIMITIVE_TOPOLOGY top)
{
	unsigned int stride;
	unsigned int offset;
