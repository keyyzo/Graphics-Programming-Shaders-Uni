...
OrbParticles::OrbParticles(ID3D11Device* device, ID3D11DeviceContext* deviceContext, int lresolution)
{
...
void OrbParticles::initBuffers(ID3D11Device* device)
{
...
void OrbParticles::sendData(ID3D11DeviceContext* deviceContext, D3D_PRIMITIVE_TOPOLOGY top)
{
	unsigned int stride;
	unsigned int offset;
