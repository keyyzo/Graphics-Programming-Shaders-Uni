...
float4 main(InputType input) : SV_TARGET
{
    ...
    /// Spotlight technique adapted from: https://www.braynzarsoft.net/viewtutorial/q16390-21-spotlights
    /// 21. Spot
    /// Author: Braynzar Soft
    ...
    // setting the texture alpha value to less than 1.0f
    // to allow the water plane to become transparent similar
    // to the actual effect of water
    textureColour.w = 0.35f;
